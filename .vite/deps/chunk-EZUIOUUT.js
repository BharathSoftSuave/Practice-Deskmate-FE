import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-4SFFNAKB.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-J7EWQZUD.js";
import {
  HTMLElementType,
  alpha,
...
var IconButton = React16.forwardRef(function IconButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(IconButtonRoot, {
    id,
    className: clsx_default(classes.root, className),
    centerRipple: true,
    ...
    (0, import_jsx_runtime7.jsx)("span", {
      ...
      children: (0, import_jsx_runtime7.jsx)(IconButtonLoadingIndicator, {
...
var Grow = React17.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React17.cloneElement(children2, {
        style: {
          opacity: 0,
...
var Fade = React18.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React18.cloneElement(children2, {
        style: {
          opacity: 0,
          visibility: state === "exited" && !inProp ? "hidden" : void 0,
          ...styles2[state],
...
var DialogActions = React27.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(DialogActionsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItemButton = React30.forwardRef(function ListItemButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime17.jsx)(ListItemButtonRoot, {
      ref: handleRef,
...
var ListItemSecondaryAction = React31.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(ListItemSecondaryActionRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItem = React32.forwardRef(function ListItem2(inProps, ref) {
  ...
  const children2 = React32.Children.toArray(childrenProp);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime19.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime19.jsxs)(ListItemContainer, {
        as: ContainerComponent,
        className: clsx_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState,
        ...ContainerProps,
        children: [(0, import_jsx_runtime19.jsx)(Root, {
          ...rootProps,
  ...
  return (0, import_jsx_runtime19.jsx)(ListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime19.jsxs)(Root, {
      ...
      ...componentProps,
      children: [children2, secondaryAction && (0, import_jsx_runtime19.jsx)(ListItemSecondaryAction_default, {
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types26.default.node, (props) => {
    const children2 = React32.Children.toArray(props.children);
...
var TextareaAutosize = React35.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var OutlinedInput = React40.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime27.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime27.jsxs)(React40.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React41.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsxs)(FormLabelRoot, {
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
...
var FormHelperText = React44.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime31.jsx)(FormHelperTextRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
...
var MenuList = React45.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  React45.Children.forEach(children2, (child, index) => {
  ...
  const items = React45.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React45.cloneElement(child, newChildProps);
    }
    return child;
  });
  return (0, import_jsx_runtime32.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown,
...
var Backdrop = React46.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime33.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
var SelectInput = React52.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React52.Fragment, {
...
var Select = React54.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime40.jsx)(React54.Fragment, {
    children: React54.cloneElement(InputComponent, {
...
true ? TextField.propTypes = {
  ...
  slotProps: import_prop_types46.default.shape({
    formHelperText: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.object]),
    htmlInput: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.object]),
    input: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.object]),
    inputLabel: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.object]),
    select: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types46.default.shape({
    formHelperText: import_prop_types46.default.elementType,
    htmlInput: import_prop_types46.default.elementType,
    input: import_prop_types46.default.elementType,
    inputLabel: import_prop_types46.default.elementType,
...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types48.default.oneOfType([import_prop_types48.default.oneOf(["false", "true"]), import_prop_types48.default.bool]),
  /**
   * A backdrop component. This prop enables custom backdrop rendering.
   * @deprecated Use `slots.backdrop` instead. While this prop currently works, it will be removed in the next major version.
   * Use the `slots.backdrop` prop to make your application ready for the next version of Material UI.
  ...
  slotProps: import_prop_types48.default.shape({
    ...
    container: import_prop_types48.default.oneOfType([import_prop_types48.default.func, import_prop_types48.default.object]),
  ...
  slots: import_prop_types48.default.shape({
    ...
    container: import_prop_types48.default.elementType,
...
//# sourceMappingURL=chunk-EZUIOUUT.js.map
